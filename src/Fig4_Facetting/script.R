...
# Make 9 versions of baseline to appear across all facets
...
p3v3_baseline_df <- baseline_df %>%
  ...
  mutate(population = sum(sircovid:::sircovid_population(region))) %>%
  ungroup()
baseline_df <- rbind(p1v1_baseline_df, p1v2_baseline_df, p1v3_baseline_df,
                     p2v1_baseline_df, p2v2_baseline_df, p2v3_baseline_df,
                     p3v1_baseline_df, p3v2_baseline_df, p3v3_baseline_df)
rm(p1v1_baseline_df, p1v2_baseline_df, p1v3_baseline_df,
   p2v1_baseline_df, p2v2_baseline_df, p2v3_baseline_df,
   p3v1_baseline_df, p3v2_baseline_df, p3v3_baseline_df)
